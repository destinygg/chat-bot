...
| !jdam                                          | (duration) {phrase or regex} | IPBans anyone using the nuked phrase for 10m by default. If a non-regex phrase is used, it gets turned into a regex with word boundaries on each side, making the 'strike' more precise. Otherwise identical to !meganuke.              | Yes            | !jdam 30m KING MOUTON !jdam 30d /[A-Z]+\s?420/            |
