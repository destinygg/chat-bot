...
| !breakingnews !breaking                        | (max link age)               | Toggles breaking news mode. When turned on, mutes old links (5m by default). Currently only supports twitter links. | Yes | !breaking 5m                       |
