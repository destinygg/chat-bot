...
const {
  ...
  answer,
  stone,
} = require('../commands/implementations/gulag');
...
function registerCommandsFromFiles(commandRegistry, chatConnectedTo, config) {
  ...
  if (chatConnectedTo === 'dgg') {
    ...
    commandRegistry.registerCommand('!release', release);
    commandRegistry.registerCommand('!purge', purge);
    commandRegistry.registerCommand('!revolution', revolution);
    commandRegistry.registerCommand('!answer', answer);
    commandRegistry.registerCommand('!stone', stone);
  }
}
