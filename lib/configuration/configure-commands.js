...
function registerCommandsFromFiles(commandRegistry) {
  ...
  commandRegistry.registerCommand('!addschcmd', addschedulecommand, ['!schedule', '!asc']);
  ...
  commandRegistry.registerCommand('!schedule', schedule);  
...
async function setupCommandsAndCachesFromDb(
  ...
  bannedPhrases.forEach((phrase) => {
    spamPunishments.addBannedPhrase(
      { text: phrase.text, duration: phrase.duration, type: phrase.type },
    );
  });
}
