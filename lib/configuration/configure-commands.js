...
const { timeBomb, defuse } = require('../commands/implementations/time-bomb');
...
function registerCommandsFromFiles(commandRegistry, chatConnectedTo, config) {
  ...
  commandRegistry.registerCommand('!timebomb', timeBomb, ['!timeban']);
  commandRegistry.registerCommand('!defuse', defuse, ['!disarm']);
