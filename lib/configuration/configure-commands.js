...
const { startNewThread, stopQuestionSubmissions, getThreadInfo } = require('../commands/implementations/reddit-questions');
const { getDuo, updateDuo } = require('../commands/implementations/duo');
const { voteBan, voteIpban } = require('../commands/implementations/voteban');

function registerCommandsFromFiles(commandRegistry, chatConnectedTo) {
  ...
  commandRegistry.registerCommand('!deletecommand', deleteCommand, ['!dc']);
  commandRegistry.registerCommand('!listcommands', listCommands, ['!lc']);
  ...
  if (chatConnectedTo === 'dgg') {
    ...
    commandRegistry.registerCommand('!questions', getThreadInfo, ['!podcastquestions', '!dtquestions', '!dtsubmissions', '!!dtq']);
    commandRegistry.registerCommand('!newsubquestions', startNewThread, ['!nsq', '!newredditquestions']);
    commandRegistry.registerCommand('!stopsubquestions', stopQuestionSubmissions, ['!ssq', '!stopredditquestions']);
  }
}
