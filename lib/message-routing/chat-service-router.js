...
class ChatServiceRouter {
  /**
   * @param {string} chatToConnectTo
   * @param {import("../services/twitch-chat") | import("../services/destinychat")} bot
   * @param {import("./message-router")} messageRouter
   * @param {import("./command-router")} commandRouter
   * @param {import("../services/logger").type} logger
   * @param {import("../services/punishment-read-write-stream")} punishmentStream
   * @param {import("../services/message-scheduler")} messageSchedulerStream
   * @param {import("../services/fake-command-scheduler")} fakeScheduler
   * @param {import("../services/message-relay")} messageRelay
   */
  constructor(
    chatToConnectTo,
    bot,
    ...
    this.bot.on('command', (commandObject) => {
      this.commandRouter
        ...
        .then((outputObject) => {
          ...
          if (outputObject.isMultiLine && outputObject.isWhisper === false) {
