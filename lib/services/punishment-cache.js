...
class PunishmentCache {
  constructor(config) {
    ...
    this.aegisCache = [];
    /**
     * @type {Object<string, AegisedViewer>}
     */
  ...
  /**
   * @param {any[]} userList
   * @param {string | RegExp} nukedPhrase
   * @param {number} duration
   * @param {boolean} isMegaNuke
   */
