...
/**
 * @param {moment.DurationInputArg1} durationSeconds
 */
...
class PunishmentReadWriteStream extends Transform {
   ...
   * @param {import("../chat-utils/punishment-helpers").MakeBanUser|import("../chat-utils/punishment-helpers").MakeMuteUser|import("../chat-utils/punishment-helpers").MakeUnmuteUser|import("../chat-utils/punishment-helpers").MakeUnbanUser} punished
   */
  ...
  /**
   * @param {string} reason
   * @param {number} muteDuration
   * @param {any} type
   * @param {any} user
   */
  sendMute(reason, muteDuration, type, user) {
    const clampedMutedDuration = _.clamp(muteDuration, 0, 604000);
    this.push({
      user,
